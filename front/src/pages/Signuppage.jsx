    ...
    <>
      <s.Wrapper>
        <s.Container>
          ...
          <s.login_container>
            <s.login_name_choice>
              <s.login_title onClick={onClickLogin}>로그인</s.login_title>
              <s.signup_title onClick={onClickSignup}>회원가입</s.signup_title>
            </s.login_name_choice>

            <form onSubmit={post_signup}>
              <s.login_box>
                <s.login_input>
                  <s.login_id>
                  ...
                  <s.signup_name>
                    <s.signup_name_img src={signup_name} alt="" />
                    <s.login_input_box
                      type="text"
                      placeholder="이름"
                      name="name"
                ...
                <s.login_btn type="submit">회원가입</s.login_btn>
              </s.login_box>
            </form>
          </s.login_container>
        </s.Container>
